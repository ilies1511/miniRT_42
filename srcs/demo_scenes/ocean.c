...
/*   Updated: 2024/10/09 22:36:09 by iziane           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ocean(t_world *world)
{
	...
	floor = eng_new_plane();
	eng_set_transform((t_obj_ptr)&water, mtx_translate(0.00000001, 0.0000001, 0.000001));
	floor.base_obj.material = eng_sand();
	eng_set_transform((t_obj_ptr)&floor, mtx_translate(0.0000001, -40.000001, 0.000001));
	sky = eng_new_plane();
