...
int	test_normal_at(void)
{
	...
	ist = eng_normal_at((t_obj *)&sphere, new_point(0, 1.70711, -0.70711));
	...
	eng_set_transform((t_obj *)&sphere2, m2);
	ist2 = eng_normal_at((t_obj *)&sphere2, new_point(0, (sqrt(2.0) / 2.0), (-sqrt(2.0) / 2.0)));
