...
static void add_objs(t_world *world)
{
	...
	eng_set_transform((t_obj_ptr)sph_right.base_obj.material.pattern, mtx_scale(0.1, 0.1, 0.1));
	...
	//eng_set_transform((t_obj_ptr)sph_mid.base_obj.material.pattern, mtx_scale(0.1, 0.1, 0.1));
	//eng_set_transform((t_obj_ptr)sph_mid.base_obj.material.pattern, mtx_rotation_y(M_PI_4));
	eng_add_obj_to_world(world, (t_obj_ptr)&sph_mid);

	//sph_mid2 = eng_new_glass_sphere();
	//eng_set_transform((t_obj_ptr)&sph_mid2 , mtx_translate(-0.5, 2, -3));
	//eng_set_transform((t_obj_ptr)&sph_mid2 , mtx_scale(0.3, 0.3, 0.3));
	...
	//eng_add_obj_to_world(world, (t_obj_ptr)&sph_mid2);
	...
	//eng_set_transform((t_obj_ptr)sph_left.base_obj.material.pattern, mtx_scale(0.1, 0.1, 0.1));
	...
	//eng_add_obj_to_world(world, (t_obj_ptr)&light3);
	(void)light2;
	(void)sph_mid;
	(void)sph_mid2;
	(void)light3;
